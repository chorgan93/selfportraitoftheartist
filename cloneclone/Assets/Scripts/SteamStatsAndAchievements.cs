...
class SteamStatsAndAchievements : MonoBehaviour
{
    ...
    private Achievement_t[] m_Achievements = new Achievement_t[] {
        ...
        new Achievement_t(Achievement.ACH_TRACK_03, "Inside", "Complete Track 3"),
        new Achievement_t(Achievement.ACH_TRACK_04, "When the Sun Hits", "Complete Track 4"),
        new Achievement_t(Achievement.ACH_TRACK_05, "Stay Here", "Complete Track 5"),
        new Achievement_t(Achievement.ACH_TRACK_06, "No Stars", "Complete Track 6"),
        new Achievement_t(Achievement.ACH_TRACK_07, "Lethean", "Complete Track 7"),
        new Achievement_t(Achievement.ACH_TRACK_08, "One Last Time", "Complete Track 8"),
        new Achievement_t(Achievement.ACH_TRACK_09, "Run Away With Me", "Complete Track 9"),
        new Achievement_t(Achievement.ACH_SAC_01, "sacrament i.", "Complete sacrament i."),
        new Achievement_t(Achievement.ACH_SAC_03, "sacrament iii.", "Complete sacrament iii."),
        new Achievement_t(Achievement.ACH_SAC_04, "sacrament iv.", "Complete sacrament iv."),
        new Achievement_t(Achievement.ACH_SAC_05, "sacrament v.", "Complete sacrament v."),
        new Achievement_t(Achievement.ACH_SAC_07, "sacrament vii.", "Complete sacrament vii."),
        new Achievement_t(Achievement.ACH_CORRUPTION, "Corrupted", "Become Corrupted"),
        new Achievement_t(Achievement.ACH_NO_FAMILIAR, "Heartless", "Give up your Familiar"),
        new Achievement_t(Achievement.ACH_NEW_GAME_PLUS, "Marked", "Begin New Game †"),
        new Achievement_t(Achievement.ACH_SAVE_MICHAEL, "Selfless", "Save Michael during The Hive"),
        new Achievement_t(Achievement.ACH_GARDEN, "Loved", "Pet all Familiars"),
        new Achievement_t(Achievement.ACH_FINAL_STATION, "End of the World", "Ride the subway to the final station"),
        new Achievement_t(Achievement.ACH_HOLLOW, "Fallen", "Choose to fight The Hollow"),
        new Achievement_t(Achievement.ACH_ARENA, "Champion", "S-rank all arena fights"),
        new Achievement_t(Achievement.ACH_ARCADE, "IAMNOTAMACHINE", "Complete the arcade game"),
        new Achievement_t(Achievement.ACH_THOMAS, "Indulgence", "Defeat Thomas"),
        new Achievement_t(Achievement.ACH_100_PERCENT, "Found", "Find all Mantras, Virtues, and Familiars"),
        new Achievement_t(Achievement.ACH_HARD_MODE, "Confident", "Reach a non-Corruption ending on Hard Sin & Punishment"),
        new Achievement_t(Achievement.ACH_CHALLENGE_MODE, "Beautiful", "Reach a non-Corruption ending on Challenge Sin & Punishment"),
    ...
    private void Update()
    {
        ...
        if (m_bStoreStats)
        {
            ...
            // set stats
            // if we end up using stats for LUCAH, set them here
