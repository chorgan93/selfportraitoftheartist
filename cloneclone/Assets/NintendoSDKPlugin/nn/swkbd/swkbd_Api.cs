...
namespace nn.swkbd
{
    public static partial class Swkbd
    {
...
#else
        public static Result ShowKeyboard(StringBuilder pOutResultString, ShowKeyboardArg showKeyboardArg, [MarshalAs(UnmanagedType.U1)] bool suspendUnityThreads)
        {
#if UNITY_SWITCH && ENABLE_IL2CPP
            if (suspendUnityThreads)
            {
                UnityEngine.Switch.Applet.Begin();
                Result result = ShowKeyboard(pOutResultString, showKeyboardArg);
                UnityEngine.Switch.Applet.End();
                return result;
            }
#endif
            return ShowKeyboard(pOutResultString, showKeyboardArg);
        }
        public static Result ShowKeyboard(byte[] pOutResultString, ShowKeyboardArg showKeyboardArg, [MarshalAs(UnmanagedType.U1)] bool suspendUnityThreads)
        {
#if UNITY_SWITCH && ENABLE_IL2CPP
            if (suspendUnityThreads)
            {
        ...
        public static extern Result ShowKeyboard([In, Out] StringBuilder pOutResultString, ShowKeyboardArg showKeyboardArg);
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "nn_swkbd_ShowKeyboard", CharSet = CharSet.Unicode)]
        public static extern Result ShowKeyboard([In, Out] byte[] pOutResultString, ShowKeyboardArg showKeyboardArg);
        [DllImport(Nn.DllName,
            CallingConvention = CallingConvention.Cdecl,
