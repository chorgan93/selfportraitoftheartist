...
namespace nn.irsensor
{
    public static partial class ImageTransferProcessor
    {
        ...
        public static void GetDefaultConfig(ref ImageTransferProcessorConfig pOutValue) { }
        public static void GetDefaultConfig(ref ImageTransferProcessorExConfig pOutValue) { }
        public static void Run(IrCameraHandle handle, ImageTransferProcessorConfig config, IntPtr workBuffer, long workBufferSize) { }
        public static void Run(IrCameraHandle handle, ImageTransferProcessorExConfig config, IntPtr workBuffer, long workBufferSize) { }
        public static nn.Result GetState(ref ImageTransferProcessorState pOutState, IntPtr pOutImage, long size, IrCameraHandle handle) { return new nn.Result(); }
        public static void InitializeWorkBuffer(ref IntPtr pOutWorkBuffer, ref long pOutWorkBufferSize, ImageTransferProcessorConfig config) { }
        public static void InitializeWorkBuffer(ref IntPtr pOutWorkBuffer, ref long pOutWorkBufferSize, ImageTransferProcessorExConfig config) { }
        public static void DestroyWorkBuffer(IntPtr workBuffer) { }
    }
#else
